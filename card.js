...
(function(){
  ...
  .then(data =>
  {
    ...
    .then(data => 
      ...
      document.getElementById("image1").innerHTML=`<h3>${data.cards[0].suit}</h3><br><img src="${data.cards[0].image}" width="200px" height="300px">`;
      document.getElementById("image2").innerHTML=`<h3>${data.cards[1].suit}</h3><br><img src="${data.cards[1].image}" width="200px" height="300px">`;
      document.getElementById("image3").innerHTML=`<h3>${data.cards[2].suit}</h3><br><img src="${data.cards[2].image}" width="200px" height="300px">`;
      document.getElementById("image4").innerHTML=`<h3>${data.cards[3].suit}</h3><br><img src="${data.cards[3].image}" width="200px" height="300px">`;
      document.getElementById("image5").innerHTML=`<h3>${data.cards[4].suit}</h3><br><img src="${data.cards[4].image}" width="200px" height="300px">`;
